...
public class Chrome extends Navegador {
    ...
    private static final String CHROME_BINARY =  "C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe";
    private static final String CHROME_CANARY_BINARY =  "C:\\Users\\Usuario\\AppData\\Local\\Google\\Chrome SxS\\Application\\chrome.exe";
